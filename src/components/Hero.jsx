    ...
    <>
        <section className=' text-white hero mt-20 flex w-[80vw] pl-[3vw] overflow-hidden'>
            <motion.div variants={textVariant('.2')} className='hero-left w-[459px] h-[461px] mt-5 ml-[-4vw]'>
                ...
                <p className='hero-p pl-[2.5vw] text-[#bebcbc] text-[20px] leading-[30px] tracking-[-0.63px] mt-10'>Outcome centered products that reduce churn, optimize pricing, and grow subscription business end-to-end.</p>
